...
// Modern Glowing I-beam cursor for text inputs
const TextCursorSVG = () => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        >
            <defs>
                <linearGradient id="textCursorGradient" x1="0%" y1="0%" x2="0%" y2="100%">
            ...
            >
                ...
                {/* Top and Bottom Horizontal Tickers (making it a true I-beam) */}
                <motion.rect
                    x="6" y="4" width="8" height="1.5" rx="0.75"
                    fill="url(#textCursorGradient)"
                    animate={{ opacity: [0.2, 0.8, 0.2] }}
                    transition={{ duration: 0.8, repeat: Infinity, ease: "easeInOut" }}
                />
                <motion.rect
                    x="6" y="34.5" width="8" height="1.5" rx="0.75"
                    fill="url(#textCursorGradient)"
                    animate={{ opacity: [0.2, 0.8, 0.2] }}
                    transition={{ duration: 0.8, repeat: Infinity, ease: "easeInOut" }}
                />
...
export function SmoothCursor({
    ...
    useEffect(() => {
        ...
        const smoothMouseMove = (e) => {
            ...
            // Check element type - only for text inputs
